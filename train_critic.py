'''
    ...
    Electra Discriminator
        ...
        Seems to be stable than Roberta series, validation loss doesn't diverge

    Note: WebGPT seems to use EMA as well, however EMA on short training loop sound questionable
...
if __name__ == "__main__":
    ...
    epochs = 5 # webgpt RM finetuned for 2 epochs
    batch_size = 12 if 'large' in pretrain_name else 32
